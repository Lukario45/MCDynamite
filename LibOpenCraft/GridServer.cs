...
namespace MCDynamite
{
    public class GridServer
    {
        ...
        public ServerEvent onServerStart = null;
        public ServerEvent onServerStop = null;
        ...
        public void SetupModules()
        {
            ...
            DirectoryCatalog directoryCatalog = new DirectoryCatalog(AppDomain.CurrentDomain.BaseDirectory, "MCDynamite.*.dll");
            #region Make Catalog
