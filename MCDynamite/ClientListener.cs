...
namespace MCDynamite
{
    ...
    {
        public delegate void ClientListenerEvent();
        public ClientListenerEvent onClientListenerStart = null;
        public ClientListenerEvent onClientListenerStop = null;
        ...
        public override void Start()
        {
            base.Start();
            listener.Start(this);
            if (onClientListenerStart != null) onClientListenerStart();
        }
        ...
        public override void Stop()
        {
            base.Stop();
            listener.Abort();
            if (onClientListenerStop != null) onClientListenerStop();
        }
